...
<head>
    ...
    <?php
        ...
        $sql = "SELECT * FROM lojanormal WHERE GeneroIdade = '".$_GET['generoidade']."';";
        ...
        echo"<title>".$_GET['generoidade']."</title>";
    ?>
</head>
<body>
<div class="sectionForNavbar" id="section"></div>
    ...
    <div class="col-12">
      <?php echo"<h1>".$_GET['generoidade']."</h1>";?>
    </div>
    ...
    <div class="col-12">
        ...
        <div class="row">
            <?php
                $sqlAlpine = "SELECT * FROM lojanormal WHERE Equipa = 'Alpine' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlAstonMartin = "SELECT * FROM lojanormal WHERE Equipa = 'Aston Martin' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlFerrari = "SELECT * FROM lojanormal WHERE Equipa = 'Ferrari' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlHaas = "SELECT * FROM lojanormal WHERE Equipa = 'Haas' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlKickSauber = "SELECT * FROM lojanormal WHERE Equipa = 'Kick Sauber' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlMcLaren = "SELECT * FROM lojanormal WHERE Equipa = 'McLaren' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlMercedes = "SELECT * FROM lojanormal WHERE Equipa = 'Mercedes' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlRB = "SELECT * FROM lojanormal WHERE Equipa = 'RB' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlRedBull = "SELECT * FROM lojanormal WHERE Equipa = 'Red Bull' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
                ...
                $sqlWilliams = "SELECT * FROM lojanormal WHERE Equipa = 'Williams' AND GeneroIdade = '".$_GET['generoidade']."' ORDER BY sitef2.lojanormal.Nome ASC LIMIT 1000;";
